...
* </p>
*/
public final class MyEvaluator implements RecommenderIRStatsEvaluator {
 
 private static final Logger log = LoggerFactory.getLogger(MyEvaluator.class);
 ...
 public IRStatistics evaluate(RecommenderBuilder recommenderBuilder,
   ...
   while (it.hasNext()) {
     ...
     if (numRecommendedItems > 0) {
       ...
       System.out.println("precision: " + (double) intersectionSize / (double) numRecommendedItems);
     }

     // Recall
     recall.addDatum((double) intersectionSize / (double) numRelevantItems);
     System.out.println("recall: " + (double) intersectionSize / (double) numRelevantItems);
